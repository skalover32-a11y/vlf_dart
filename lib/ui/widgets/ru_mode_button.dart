...
class RuModeButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final shadow = isEnabled
        ? [BoxShadow(color: const Color(0xFF2AAFC0).withOpacity(0.25), blurRadius: 12, offset: const Offset(0, 6))]
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Center(
          child: Text(
            'Режим РФ',
            style: TextStyle(color: isEnabled ? Colors.white : Colors.white70, fontSize: 15, fontWeight: FontWeight.w600),
          ),
        ),
      ),
    );
